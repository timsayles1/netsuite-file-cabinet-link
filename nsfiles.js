function fileLink(r) {var rl = nlapiLookupField("file",Number(r.innerHTML),"URL");navigator.clipboard.writeText(window.location.origin + rl);alert("Link copied to clipboard");}						
						
						document
							.querySelectorAll('a[onclick^="showFolderContents"')
								.forEach(folder => {
						...
						document
							.querySelectorAll('#medialisthdr_t a')
								.forEach(folder => {
